...
// offers start
{
    ...
    name: "Australian Dehydrated Food Products Basket",
    details: "An Australian Dehydrated Food Products basket offers a delightful assortment of dried fruits sourced from the diverse regions of Australia. This unique combination showcases the rich flavors and natural sweetness of fruits grown in the Australian climate. From the sun-kissed orchards of Victoria to the tropical plantations of Queensland, each fruit embodies the essence of Australia's fertile lands",
    price: " Price : PKR 2,000",
},
{
    id: 105,
    imgSrc: '../assets/offer-page/off-2.png',
    name: " American Dehydrated Food Products Basket ",
    details: "An American Dehydrated Food Products basket is a delightful selection of dried fruits sourced from the diverse regions of the United States. From the orchards of California to the cranberry bogs of Massachusetts, each fruit in this basket embodies the unique flavors and agricultural heritage of America.",
    price: " Price : PKR 2,500",
},
{
    id: 106,
    imgSrc: '../assets/offer-page/off-3.png',
    name: "Pakistani Dehydrated Food Products Basket",
